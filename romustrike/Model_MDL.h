...
inline int 
Model_MDL::VectorCompare(const v3_t& v1, const v3_t& v2) const
{
	int		i;
...
inline double 
Model_MDL::VectorLength(const v3_t& v) const
{
	int		i;
	double	length;
...
inline vec_t 
Model_MDL::Q_rint (const vec_t& in) const
{
	return floor (in + 0.5f);
}

inline void 
Model_MDL::VectorMA (const v3_t& va, double scale, const v3_t& vb, v3_t& vc) const
{
...
inline void 
Model_MDL::CrossProduct (const v3_t& v1, const v3_t& v2, v3_t& cross) const
{
...
inline vec_t 
Model_MDL::_DotProduct (const v3_t& v1, const v3_t& v2) const
{
	return v1[0]*v2[0] + v1[1]*v2[1] + v1[2]*v2[2];
}

inline void 
Model_MDL::_VectorSubtract (const v3_t& va, const v3_t& vb, v3_t& out) const
{
	out[0] = va[0]-vb[0];
	out[1] = va[1]-vb[1];
	out[2] = va[2]-vb[2];
...
inline void 
Model_MDL::_VectorAdd (const v3_t& va, const v3_t& vb, v3_t& out) const
{
	out[0] = va[0]+vb[0];
	out[1] = va[1]+vb[1];
	out[2] = va[2]+vb[2];
...
inline void 
Model_MDL::_VectorCopy (const v3_t& in, v3_t& out) const
{
	out[0] = in[0];
	out[1] = in[1];
	out[2] = in[2];
...
inline void 
Model_MDL::_VectorScale (const v3_t& v, vec_t scale, v3_t& out) const
{
	out[0] = v[0] * scale;
	out[1] = v[1] * scale;
	out[2] = v[2] * scale;
...
inline vec_t 
Model_MDL::VectorNormalize (v3_t& v) const
{
	int		i;
	float	length;
...
inline void 
Model_MDL::VectorInverse (v3_t& v) const
{
	v[0] = -v[0];
	v[1] = -v[1];
	v[2] = -v[2];
...
inline void 
Model_MDL::VectorRotate (const v3_t& in1, const float in2[3][4], v3_t& out) const
{
...
inline void 
Model_MDL::VectorIRotate (const v3_t& in1, const float in2[3][4], v3_t& out) const
{
...
inline void 
Model_MDL::VectorTransform (const v3_t& in1, const float in2[3][4], v3_t& out) const
{
...
inline void 
Model_MDL::VectorTransform2 (const float *in1, float in2[3][4], float *out)
{
	out[0] = DotProduct(in1, in2[0]) + in2[0][3];
	out[1] = DotProduct(in1, in2[1]) + in2[1][3];
	out[2] = DotProduct(in1, in2[2]) + in2[2][3];
...
inline vec3_t 
Model_MDL::StudioCalcAttachments( bool moi )
{
	int i;
