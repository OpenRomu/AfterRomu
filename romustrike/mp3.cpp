...
Cmp3::Cmp3(IGraphBuilder *builder ): g_iNumFiles ( 3), g_iNextFile ( 0),g_pGraphBuilder(NULL),g_pMediaControl(NULL),g_pMediaSeeking(NULL),g_pSourceCurrent(NULL),g_pSourceNext(NULL) ,pEvent(NULL)
{
  // Initialize COM
