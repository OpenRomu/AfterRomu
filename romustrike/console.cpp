...
console::console():lengthc(35),tps_vie(0.0f),visible(false),m_mousemove(false),m_mouseclick(false),m_release(false),m_coords(NULL) ,m_font(NULL)
{
...
void console::SetFont(Font * in_font)
{
	 	m_font = in_font;
}
...
void console::SetText(char * in_text)
{
		strcpy(text,in_text);
