...
void 
Font::print(int x, int y, const char* s)
{
 ...
 glTexParameteri (GL_TEXTURE_2D,GL_TEXTURE_MIN_FILTER,GL_LINEAR);
    ...
    glBegin(GL_QUADS);
        ...
        while(c = *s++) {
            ...
            glTexCoord2fv(z->c00); glVertex2s(x,y);
            glTexCoord2fv(z->c10); glVertex2s(x+taille,y);
            glTexCoord2fv(z->c11); glVertex2s(x+taille,y+taille);
            glTexCoord2fv(z->c01); glVertex2s(x,y+taille);
			}
			else
			{
