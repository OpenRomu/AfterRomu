...
struct glTga_t : public tga_t
{
    ...
    void SetMinFilter(GLint m)
    {
        minFilter = m;
    }
    GLint GetMinFilter(void)
    {
        return minFilter;
    }
    void SetMagFilter(GLint m)
    {
        magFilter = m;
    }
    GLint GetMagFilter(void)
    {
        return magFilter;
    }
    void SetWrapS(GLint m)
    {
        wrapS = m;
    }
    GLint GetWrapS(void)
    ...
    void SetTexEnv(GLint m)
    {
        texEnv = m;
    }
    GLint GetTexEnv(void)
    {
        return texEnv;
    }
    ...
    void SetInternal(GLenum m)
    {
        internal = m;
    }
    GLenum GetInternal(void)
    {
        return internal;
    }
    void SetupFormat(void); // test
    void GenId(int num, uint *dest)
    {
        glGenTextures(num, dest);
    }
