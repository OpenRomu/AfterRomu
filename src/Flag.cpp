...
void AFlag::affecte_modele(Model_MDL *lesobjets, BYTE id_mod, int max)
{
...
bool AFlag::collision_Flg(DPNID le_id, vec3_t src, int la_team)
{
...
bool AFlag::collision_Cmp(DPNID le_id, DPNID le_id_joueur, vec3_t src, int la_team)
{
