...
bsp_file_t::bsp_file_t(const char *filename)
    : model_count(0), models(0), face_count(0), faces(0), plane_count(0), planes(0), edge_count(0), edges(0),
      edge_list_count(0), edge_list(0), vertex_count(0), vertices(0), texinfo_count(0), texinfo(0), tex_count(0),
      textures(0), lightmap_count(0), lightmaps(0), node_count(0), nodes(0), clipnode_count(0), clipnodes(0),
      leaf_count(0), leaves(0), marksurface_count(0), marksurfaces(0), vis_count(0), vis(0), entities_count(0),
      entities(0)
{
    ...
    marksurfaces =
        (unsigned short *)suck_lump(f, h.lumps[LUMP_MARKSURFACES], sizeof(unsigned short), marksurface_count);
