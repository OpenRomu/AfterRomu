...
struct pGrenSystem_t
{
    ...
    pGrenSystem_t *GetNext(void)
    {
        return next;
    }
    pGrenSystem_t *GetPrev(void)
    {
        return prev;
    }
    pGren_t *GetAlive(void)
    {
        return &pUse;
    }
    int GetType(void)
    ...
    void SetNext(pGrenSystem_t *n)
    {
        next = n;
    }
    void SetPrev(pGrenSystem_t *p)
    {
        prev = p;
    }
    void SetEXPLODE(pParticleManager_t *p)
    {
        engineparts = p;
    }
