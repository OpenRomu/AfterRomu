...
CXmlMessaging::Crypt(char * result,const char * method,const char * src);
    ...
    long DevenirServer(playerfile_t * playerconfig,char* version,short int bcft,DWORD MaxPlayers,int cle_tournois,int round,char* md5,char* desc,bool privee,char * armes_autoriser) ;
