...
class world_t
{
  public:
    world_t()
        : wireframe_mode(false), anim_tex(0), bsp(0), epsilon(0.3f), mark_faces(0), SkyRange(6000.0), znear(1.0),
          use_multi(true), got_flag(false)
    {
